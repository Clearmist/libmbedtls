...
#define ONE_ITERATION                                                                                                  \
    ...
    PTEST = PT1 >> 20;                                                                                                 \
                                                                                                                       \
    TST1_ENTER TST1_ENTER TST1_ENTER TST1_ENTER TST1_ENTER TST1_ENTER TST1_ENTER TST1_ENTER TST1_ENTER TST1_ENTER      \
        TST1_ENTER TST1_ENTER                                                                                          \
                                                                                                                       \
            TST1_LEAVE TST1_LEAVE TST1_LEAVE TST1_LEAVE TST1_LEAVE TST1_LEAVE TST1_LEAVE TST1_LEAVE TST1_LEAVE         \
    ...
    *D = (*D >> (8)) ^ (*D << (24)) ^ CLK;                                                                             \
    ...
    PTY = (PT2 >> 10) & 7;                                                                                             \
                                                                                                                       \
    TST2_ENTER TST2_ENTER TST2_ENTER TST2_ENTER TST2_ENTER TST2_ENTER TST2_ENTER TST2_ENTER TST2_ENTER TST2_ENTER      \
        TST2_ENTER TST2_ENTER                                                                                          \
                                                                                                                       \
            TST2_LEAVE TST2_LEAVE TST2_LEAVE TST2_LEAVE TST2_LEAVE TST2_LEAVE TST2_LEAVE TST2_LEAVE TST2_LEAVE         \
    ...
    *D = (*D >> (16)) ^ (*D << (16)) ^ CLK;                                                                            \
                                                                                                                       \
    PT1 = (RES[(i - 8) ^ PTX] ^ WALK[PT1 ^ PTX ^ 7]) & (~1);                                                           \
    PT1 ^= (PT2 ^ 0x10) & 0x10;                                                                                        \
                                                                                                                       \
    for (n++, i = 0; i < 16; i++)                                                                                      \
