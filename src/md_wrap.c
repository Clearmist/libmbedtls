...
static int md2_update_wrap(void *ctx, const unsigned char *input, size_t ilen)
{
...
static int md4_update_wrap(void *ctx, const unsigned char *input, size_t ilen)
{
...
static int md5_update_wrap(void *ctx, const unsigned char *input, size_t ilen)
{
...
static int ripemd160_update_wrap(void *ctx, const unsigned char *input, size_t ilen)
{
...
{
    return (mbedtls_internal_ripemd160_process((mbedtls_ripemd160_context *)ctx, data));
}
...
static int sha1_update_wrap(void *ctx, const unsigned char *input, size_t ilen)
{
...
static int sha224_update_wrap(void *ctx, const unsigned char *input, size_t ilen)
{
...
static int sha224_wrap(const unsigned char *input, size_t ilen, unsigned char *output)
{
...
static int sha384_update_wrap(void *ctx, const unsigned char *input, size_t ilen)
{
...
static int sha384_wrap(const unsigned char *input, size_t ilen, unsigned char *output)
{
...
{
    return (mbedtls_internal_sha512_process((mbedtls_sha512_context *)ctx, data));
}
...
static int sha512_wrap(const unsigned char *input, size_t ilen, unsigned char *output)
{
